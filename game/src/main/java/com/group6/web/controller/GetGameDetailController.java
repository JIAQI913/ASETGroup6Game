...
//	public ModelAndView getGameDetail(@RequestParam("json") String selectGameDetail, HttpServletRequest req, HttpServletResponse resp) {
...
//		modelAndView.addObject("developers", FormatList.changeToString(InteractWithIGDB.getTypeString("companies", game.getDevelopers())));
//		modelAndView.addObject("publishers", FormatList.changeToString(InteractWithIGDB.getTypeString("companies", game.getPublishers())));
//		modelAndView.addObject("gameRelated", FormatList.changeToString(InteractWithIGDB.getTypeString("games", game.getGame())));
//		modelAndView.addObject("count", session.getAttribute("responseCount"));
...
//		System.out.println(game.getDevelopers());
//		session.setAttribute("developers", FormatList.changeToString(InteractWithIGDB.getTypeString("companies", game.getDevelopers())));
//		session.setAttribute("publishers", FormatList.changeToString(InteractWithIGDB.getTypeString("companies", game.getPublishers())));
//		session.setAttribute("gameRelated", FormatList.changeToString(InteractWithIGDB.getTypeString("games", game.getGame())));		
		modelAndView.setViewName("gameDetail");
		return modelAndView;	
	}
