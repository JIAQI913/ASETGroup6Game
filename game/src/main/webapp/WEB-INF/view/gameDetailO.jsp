			...
			<div class="gamepage-summary">
				<div class="gamepage-title-container" style="height: 88px;">
					<div class="gamepage-title-wrapper">
						...
						<h2 class="banner-subheading" style="padding-left: 5px;">7th
							Sep, 2016</h2>
				...
				<div class="gamepage-tabs">
					...
					<div class="easyui-tabs" style="width: 550px; height: 180px;">
						<div title="About" style="padding: 10px">
							<p>
								<span class="text-semibold">Genre: </span> <a href=""
									style="color: #27AE60;">Indie</a> <a href=""
									style="color: #27AE60;">Simulator</a> <a href=""
									style="color: #27AE60;">Adventure</a>
							</p>
							<div class="" data-reactid="36">
								<p>It’s a sandbox game similar to Minecraft and Terraria
									but with economy twist. In the beginning you collect resources
									to build your little settlement. You can mine ore, coal, smelt
									iron and craft tools. It features 8-bit, retro style graphics
									and soothing background music.</p>
							</div>
						</div>
